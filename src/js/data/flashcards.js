export const flashcardsData = [
  ...
  {
    topic: "Entwickeln, Erstellen und Betreuen von IT-Lösungen",
    cards: [
      {
        cardNumber: 181,
        img: "",
  ...
  {
    topic: "Qualitätssichernde Maßnahmen",
    cards: [
      {
        cardNumber: 191,
        img: "",
  ...
  {
    topic: "IT-Sicherheit und Datenschutz, Ergonomie",
    cards: [
      {
        cardNumber: 199,
        img: "",
      ...
      },
      {
        ...
        img: "",
        front:
          "Worin unterscheiden sich <b>Datensicherheit und Datenschutz</b>?",
